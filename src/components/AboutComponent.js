    ...
    <div className='container'>
      ...
      <div className='row row-content'>
        <div className='col-12 col-md-6'>
          ...
          <p>
            The restaurant traces its humble beginnings to <em>The Frying Pan</em>, a successful chain started
      ...
      <div className='row row-content'>
        ...
        <div className='col-12'>
          <CorporateLeaders leaders={props.leaders} />
        </div>
      </div>
    </div>
  );
